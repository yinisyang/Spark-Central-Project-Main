<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Technology.aspx.cs" Inherits="Catalog" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="mdl-grid" style="overflow-x: auto">
        ...
        <div class="mdl-cell mdl-cell--1-col">
            ...
            <br />
            <br />
            <asp:ImageButton ID="TechImage" Title="Technology" Height="80" ImageUrl="images/technologyS.png" runat="server" OnClick="buttonTech_Click" />
            <!-- Add Tech Button -->
