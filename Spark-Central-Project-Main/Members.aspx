...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div style="padding-left: 5%">
        ...
        <button id="show-dialog" type="button" class="mdl-button mdl-js-button mdl-button--raised">Add Member</button>
        <asp:Label ID="newMemberLabel" class="mdl-list__item-primary-content" style="color:crimson" runat="server" Text=""></asp:Label>
