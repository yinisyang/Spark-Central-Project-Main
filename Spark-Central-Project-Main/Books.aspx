<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Books.aspx.cs" Inherits="Catalog" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div class="mdl-grid" style="overflow-x: auto">
        ...
        <div class="mdl-cell mdl-cell--1-col mdl-card__menu">
            ...
            <br />
            <asp:ImageButton ID="BookImage" Title="Books" Height="80" ImageUrl="images/bookS.png" runat="server" OnClick="buttonBooks_Click" />
            <!-- Add Book Button -->
